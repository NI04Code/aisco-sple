package aisco.product.donasiewallet;
...
public class DonasiEwallet {
	    ...
	    {  
	        Donation donate = DonationFactory.createDonation("aisco.donation.pewallet.DonationImpl");
	        donate.addDonation();
	        donate.getDonation();
	    }

	    public static void main(String[] args) {
	        System.out.println ("Product Ewallet");
